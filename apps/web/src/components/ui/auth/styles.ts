...
export const styles = {
  page: "relative isolate min-h-dvh overflow-hidden bg-cover bg-center",
  overlay:
    "absolute inset-0 bg-[linear-gradient(135deg,rgba(191,217,229,0.14),rgba(255,255,255,0.16))]",
  container:
    "relative z-10 box-border flex min-h-dvh items-center justify-center py-4 !px-4 sm:!px-6 lg:!px-10",
  backLink:
  ...
  backLinkText: "hidden text-[clamp(0.75rem,1.4vw,0.875rem)] !text-slate-800 lg:inline",
};
