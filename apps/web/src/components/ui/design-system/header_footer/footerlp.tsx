...
export default function Footer() {
  ...
  return (
    <Container Component="footer" size="full" padding={true} bg_theme='blue' className="flex flex-col gap-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-10 w-full">
