...
export class UploadController {
  ...
  @ApiOperation({
    ...
    description: 'Returns a short-lived signed URL. Client must PUT the file directly to uploadUrl within 5 minutes. The fileUrl is the permanent S3 URL to store in the database.',
  })
  @ApiOkResponse({
  ...
  async presign(@Body() dto: PresignRequestDto): Promise<{ uploadUrl: string; fileUrl: string }> {
