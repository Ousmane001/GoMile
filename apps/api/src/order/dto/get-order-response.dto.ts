...
export class GetOrderResponseDto {
  ...
  @ApiProperty({ description: "Customer's phone number", example: '+33 633051129' })
  ...
  @ApiProperty({ description: "Date the driver picked up the order", type: 'string', format: 'date-time', nullable: true, example: null })
  pickedUpAt: Date | null;

  @ApiProperty({ description: "Date the order was delivered", type: 'string', format: 'date-time', nullable: true, example: null })
  deliveredAt: Date | null;

  @ApiProperty({ description: "Date the order was cancelled", type: 'string', format: 'date-time', nullable: true, example: null })
