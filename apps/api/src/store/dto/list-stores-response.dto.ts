...
class StoreOrderCountDto {
  @ApiProperty({ example: 42, description: 'Total number of orders placed at this store' })
  orders: number;
}
...
export class ListStoresResponseDto {
  ...
  @ApiProperty({ example: true, description: 'Whether the store is currently accepting orders' })
  isActive: boolean;
