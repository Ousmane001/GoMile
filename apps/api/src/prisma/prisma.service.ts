...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get handshake() { return this.client.handshake; }
  get kycSubmission() { return this.client.kycSubmission; }
  get wallet() { return this.client.wallet; }
  get walletEntry() { return this.client.walletEntry; }

  async onModuleInit() {
    await this.client.$connect();
    console.log('Models:', Object.keys(this.client).filter((k: string) => !k.startsWith('$') && !k.startsWith('_')));
  }
